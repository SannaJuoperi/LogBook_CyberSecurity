...
export async function getResources(req) {
    const query = `SELECT resource_id, resource_name, resource_description FROM xyz789_resources`;
    try {
...
export async function registerResource(req) {
    ...
    try {
        const query = `INSERT INTO xyz789_resources (resource_name, resource_description) VALUES ($1, $2)`;
